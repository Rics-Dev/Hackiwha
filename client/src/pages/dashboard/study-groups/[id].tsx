...
const members = [
    { id: '1', name: 'Amina Khelif', role: 'Creator', joinedAt: '2023-03-10T09:00:00Z', isOnline: true },
    { id: '2', name: 'Youcef Benmoussa', role: 'Member', joinedAt: '2023-03-12T14:30:00Z', isOnline: false },
    { id: '3', name: 'Lina Hadj', role: 'Member', joinedAt: '2023-03-15T10:45:00Z', isOnline: true },
    { id: '4', name: 'Karim Ziani', role: 'Member', joinedAt: '2023-03-18T16:20:00Z', isOnline: false },
    { id: '5', name: 'Sara Mansouri', role: 'Member', joinedAt: '2023-03-20T11:15:00Z', isOnline: true },
    { id: '6', name: 'Mohammed Benali', role: 'Member', joinedAt: '2023-04-05T09:30:00Z', isOnline: false },
    { id: '7', name: 'Fatima Zahra', role: 'Member', joinedAt: '2023-04-10T15:45:00Z', isOnline: true },
    { id: '8', name: 'Ahmed Taleb', role: 'Member', joinedAt: '2023-04-15T13:20:00Z', isOnline: false },
]
...
const discussions = [
    {
        ...
        content: "Welcome everyone to our Baccalaureate Math Prep group! Let's use this space to collaborate and prepare for the upcoming exams.",
    ...
    },
    {
        ...
        content: "I'm struggling with the integration by parts technique. Can we schedule a session to go through some examples?",
    ...
    },
    {
        ...
        content: 'I found this great resource for probability problems that might be helpful for everyone: [link to resource]',
        ...
        <div className="space-y-6">
            ...
            <Tabs defaultValue="overview" className="w-full" onValueChange={setActiveTab}>
                        ...
                        <div className="border rounded-lg p-6 bg-card">
                            ...
                            <div className="space-y-4">
                                {discussions.slice(0, 2).map((discussion) => (
                                    <div key={discussion.id} className="flex items-start justify-between border-b pb-3 last:border-0">
                                        <div>
                    ...
                    <div className="border rounded-lg p-6 bg-card">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {resources.slice(0, 4).map((resource) => (
                                <div key={resource.id} className="flex items-start gap-3 p-3 rounded-md border hover:border-primary/50 transition-colors">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center justify-between text-xs text-muted-foreground">
                                            <span>{resource.type === 'PDF' ? resource.size : resource.duration}</span>
                    ...
                    <div className="border rounded-lg p-6 bg-card">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                            {members.slice(0, 8).map((member) => (
                                <div key={member.id} className="flex flex-col items-center text-center p-3 rounded-md border hover:border-primary/50 transition-colors">
                ...
                <TabsContent value="discussions" className="space-y-6 mt-6">
                    ...
                    <div className="space-y-6">
                        {discussions.map((discussion) => (
                            <div key={discussion.id} className="border rounded-lg p-4 bg-card hover:border-primary/50 transition-colors">
                            ...
                            <tbody>
                                {resources.map((resource) => (
                                    <tr key={resource.id} className="border-t">
                                        ...
                                        <td className="p-3 hidden lg:table-cell">{resource.uploadedBy.name}</td>
                ...
                <TabsContent value="events" className="space-y-6 mt-6">
                    ...
                    <div className="space-y-4">
                        {events.map((event) => (
                            <div key={event.id} className="border rounded-lg p-4 bg-card hover:border-primary/50 transition-colors">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    <div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="text-center">
                                            ...
                                            <p className="text-xl font-bold text-primary">{event.attendees}/{studyGroup.members}</p>
                                        </div>
                                        <Button>
                                            Join Event
                                        </Button>
                            ...
                            <tbody>
                                {members.map((member) => (
                                    <tr key={member.id} className="border-t">
                                        ...
                                        <td className="p-3">
                                            <span className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ${member.role === 'Creator' ? 'bg-primary/10 text-primary' : 'bg-muted text-muted-foreground'}`}>
                                                {member.role}
                                            </span>
                                        </td>
                                        <td className="p-3 hidden md:table-cell">
                                        ...
                                        <td className="p-3 hidden lg:table-cell">
                                            <span className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ${member.isOnline ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-500' : 'bg-muted text-muted-foreground'}`}>
