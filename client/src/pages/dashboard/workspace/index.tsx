// src/pages/dashboard/workspace/index.tsx
...
const tasks = [
    { id: '1', title: 'Complete calculus exercises', completed: false, dueDate: '2023-05-30T23:59:59Z' },
    { id: '2', title: 'Review physics formulas', completed: true, dueDate: '2023-05-25T23:59:59Z' },
    { id: '3', title: 'Prepare for Arabic literature quiz', completed: false, dueDate: '2023-06-02T23:59:59Z' },
    { id: '4', title: 'Research history project topic', completed: false, dueDate: '2023-06-05T23:59:59Z' },
    { id: '5', title: 'Complete chemistry lab report', completed: false, dueDate: '2023-05-28T23:59:59Z' },
]
            ...
            <Tabs defaultValue="focus" className="w-full" onValueChange={setActiveTab}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="border rounded-lg p-6 bg-card">
                            ...
                            <div className="space-y-2 mb-4">
                                {taskList.filter(task => !task.completed).slice(0, 5).map((task) => (
                ...
                <TabsContent value="tasks" className="space-y-6 mt-6">
                    ...
                    <div className="border rounded-lg overflow-hidden">
                        ...
                        <div className="divide-y">
                            {taskList.map((task) => (
                                <div key={task.id} className="flex items-center p-3 hover:bg-accent/50">
                                    <div className="w-8">
                                        <input 
                                            type="checkbox" 
                                            checked={task.completed}
                ...
                <TabsContent value="documents" className="space-y-6 mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {documents.map((doc) => (
                            <div key={doc.id} className="border rounded-lg p-4 bg-card hover:border-primary/50 transition-colors">
                    ...
                    <div className="border rounded-lg p-6 bg-card">
                        ...
                        <p className="text-muted-foreground mb-4">
                            Connect your Google account to access and edit your Google Docs, Sheets, and Slides directly from your workspace.
                        </p>
                        <Button>
